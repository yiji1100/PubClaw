...
PubClaw 内置了专业的微信公众号自动排版功能，让你的文章无需手动调整即可获得精美格式。

### 排版特性

| 特性 | 效果 |
|------|------|
| **专业配色** | 微信绿主题，符合公众号视觉规范 |
| **标题样式** | H1/H2/H3 自动添加边框和渐变色 |
| **表格美化** | 绿色表头、斑马纹、响应式滚动 |
| **引用块** | 绿色左边框 + 渐变背景 |
| **代码高亮** | 深色主题，语法高亮 |
| **提示框** | 支持 💡 提示框、⚠️ 警告框自动识别 |
| **图片优化** | 圆角 + 阴影效果 |
...
在 Markdown 中使用特定表情符号，自动转换为精美提示框：

```markdown
💡 这是一个提示信息，会显示为蓝色提示框

⚠️ 这是一个警告信息，会显示为红色警告框
```
...
- [文章标题1](https://mp.weixin.qq.com/...)
- [文章标题2](https://mp.weixin.qq.com/...)
```

### 添加二维码

使用Markdown图片语法添加微信二维码：
...
如需自定义样式，可以修改 `pubclaw/platforms/wechat.py` 中的 `WECHAT_CSS` 变量。
